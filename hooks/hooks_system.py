...
class HookSystem:
    ...
    async def before_tool(self, tool_name:str,tool_params:dict[str,Any])->None:
    ...
    async def after_tool(self, tool_name:str,tool_params:dict[str,Any],tool_result:ToolResult)->None:
    ...
    async def trigger_on_error(self, error:Exception)->None:
        env= self._build_env(HookTrigger.ON_ERROR,error=str(error))
